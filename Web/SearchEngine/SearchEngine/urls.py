...
urlpatterns = [
	...
	url(r'^getFileMatchesInfo/$', se_views.getFileMatchesInfo, name='getFileMatchesInfo'),
	url(r'^fileContentReader/$', se_views.fileContentReader, name='fileContentReader'),
	url(r'^fileContentBrowser/$', se_views.fileContentBrowser, name='fileContentBrowser'),
	url(r'^blockContentBrowser/$', se_views.blockContentBrowser, name='blockContentBrowser'),
	url(r'^getRemoteDirectoryBrowserInfo/$', se_views.getRemoteDirectoryBrowserInfo, name='getRemoteDirectoryBrowserInfo'),
	
	url(r'^api_indexSearch/$', se_views.api_indexSearch, name='api_indexSearch'),
	url(r'^api_multiIndexSearch/$', se_views.api_multiIndexSearch, name='api_multiIndexSearch'),
	url(r'^api_indexSearchStatus/$', se_views.api_indexSearchStatus, name='api_indexSearchStatus'),
	url(r'^api_multiIndexSearchStatus/$', se_views.api_multiIndexSearchStatus, name='api_multiIndexSearchStatus'),
	url(r'^api_initFileContent/$', se_views.api_initFileContent, name='api_initFileContent'),
	url(r'^api_getBlockContent/$', se_views.api_getBlockContent, name='api_getBlockContent'),
